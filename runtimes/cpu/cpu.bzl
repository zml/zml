...
def _cpu_pjrt_plugin_impl(mctx):
    ...
    http_archive(
        ...
        sha256 = "71fa340776fad9ea9b490b13817360e8a79b2427a2c68f768aebb3bc97df8c34",
        url = "https://github.com/zml/pjrt-artifacts/releases/download/v0.2.4/pjrt-cpu_darwin-arm64.tar.gz",
    )
