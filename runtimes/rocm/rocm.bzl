...
def _rocm_impl(mctx):
    ...
    http_archive(
        ...
        url = "https://github.com/zml/pjrt-artifacts/releases/download/v14.0.0/pjrt-rocm_linux-amd64.tar.gz",
        sha256 = "789ad6a1696608464bdd25a12c06251861ec2d207edd8165951df2551b2a2abb",
    )
