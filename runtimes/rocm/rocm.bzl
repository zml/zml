...
def _rocm_impl(mctx):
    ...
    http_archive(
        ...
        url = "https://github.com/zml/pjrt-artifacts/releases/download/v5.1.0/pjrt-rocm_linux-amd64.tar.gz",
        sha256 = "6c0d54a22beabe9a902597f25e7d7c41a25a180f751d7e815bc1c2dadc89d063",
    )
