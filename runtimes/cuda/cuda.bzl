...
def _cuda_impl(mctx):
    ...
    http_archive(
        ...
        url = "https://github.com/zml/pjrt-artifacts/releases/download/v14.0.0/pjrt-cuda_linux-amd64.tar.gz",
        sha256 = "2fc12f7af7f82bfccdf3f3b1c1f630e9b5cef6e23315a4d5f6ad065b7dd9fad4",
    )
