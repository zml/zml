...
def _cuda_impl(mctx):
    ...
    http_archive(
        ...
        url = "https://github.com/zml/pjrt-artifacts/releases/download/v9.0.0/pjrt-cuda_linux-amd64.tar.gz",
        sha256 = "0cd5b3214e32d39f501e02d38d5166ffa7eeb9d4852cf2108c3f4f74df3fe061",
    )
