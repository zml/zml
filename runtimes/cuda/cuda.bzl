...
""",
    ...
    http_archive(
        ...
        url = "https://github.com/zml/pjrt-artifacts/releases/download/v0.2.4/pjrt-cuda_linux-amd64.tar.gz",
        sha256 = "5e432b073738635899eed57d3a4cfb1fc00bfe1d68a21b600dac224f5441a72d",
    )
