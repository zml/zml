...
def _cuda_impl(mctx):
    ...
    http_archive(
        ...
        url = "https://github.com/zml/pjrt-artifacts/releases/download/nightly-2026-04-13/pjrt-cuda_linux-amd64.tar.gz",
        sha256 = "6d195d3a28b060517e4c21eac56af53a5db3e4931b9730542c5d5a04c4946ede",
    )
