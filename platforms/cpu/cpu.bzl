...
def _cpu_plugin_impl(mctx):
    http_archive(
        ...
        url = "https://mirror.zml.ai/plugins/202609161226.43.1.b992d049cec2/zml-cpu-linux-amd64.tar.zst",
    )
    ...
    http_archive(
        ...
        url = "https://mirror.zml.ai/plugins/202609161226.43.1.b992d049cec2/zml-cpu-darwin-amd64.tar.zst",
    )
    ...
    http_archive(
        ...
        url = "https://mirror.zml.ai/plugins/202609161226.43.1.b992d049cec2/zml-cpu-darwin-arm64.tar.zst",
    )
