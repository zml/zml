...
def _cpu_plugin_impl(mctx):
    ...
    http_archive(
        ...
        url = "https://mirror.zml.ai/plugins/202609231543.88.1.e2f61df0be45/zml-cpu-linux-amd64.tar.zst",
    )
    ...
    http_archive(
        ...
        url = "https://mirror.zml.ai/plugins/202609231543.88.1.e2f61df0be45/zml-cpu-darwin-amd64.tar.zst",
    )
    ...
    http_archive(
        ...
        url = "https://mirror.zml.ai/plugins/202609231543.88.1.e2f61df0be45/zml-cpu-darwin-arm64.tar.zst",
    )
