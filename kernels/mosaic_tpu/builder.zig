...
pub const ArgSpec = struct {
    ...
    pub const WindowSpec = struct {
        ...
        /// Optional custom transform body emitter. When present, it
        /// overrides `transform_returns` and emits the full `transform_N`
        /// function body using the specialized `TransformStubBuilder`.
