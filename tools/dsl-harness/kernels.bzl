...
TRITON_KERNELS = [
    ...
    },
    {
        ...
        "src": "zig/per_token_group_quant_fp8.zig",
        "py_src": "py/per_token_group_quant_fp8.py",
        "py_kernel": "per_token_group_quant_fp8",
        "extra_py_deps": [":moe_kernels"],
    },
    {
        "name": "fused_moe",
        "src": "zig/fused_moe.zig",
        "py_src": "py/fused_moe.py",
        "py_kernel": "fused_moe_kernel",
        "extra_py_deps": [":moe_kernels"],
    },
    {
        "name": "moe_align_block_size",
        "src": "zig/moe_align_block_size.zig",
        "py_src": "py/moe_align_block_size.py",
        "py_kernel": "moe_align_block_size_kernel",
        "extra_py_deps": [":moe_kernels"],
    },
    {
        "name": "count_and_sort_expert_tokens",
        "src": "zig/count_and_sort_expert_tokens.zig",
        "py_src": "py/count_and_sort_expert_tokens.py",
        "py_kernel": "count_and_sort_expert_tokens_kernel",
        "extra_py_deps": [":moe_kernels"],
    },
    {
