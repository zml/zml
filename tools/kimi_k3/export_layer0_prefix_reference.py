...
def main() -> None:
    ...
    # KIMI_K3_TEMP_REMOVE_M20: named activation shapes and synchronized
    # timings are differential bring-up diagnostics removed during cleanup.
    if args.debug:
        print("[kimi-k3-debug] prefix timing", json.dumps(summary | {"timing": {"first": first_timing, "repeat": repeat_timing}}, sort_keys=True))
