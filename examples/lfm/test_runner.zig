...
pub fn run(allocator: std.mem.Allocator, io: std.Io, platform: *zml.Platform, config: model.Config, mdl: model.Model, model_buffers: *zml.Bufferized(model.Model), store: *zml.io.TensorStore, attention_metadata: zml.attention.Metadata, attention_parameters: zml.attention.Parameters) !void {
    _ = store;
