...
pub fn main(init: std.process.Init) !void {
    ...
    try runDecode(allocator, io, platform, .replicated, args);
}

fn runDecode(allocator: std.mem.Allocator, io: std.Io, platform: *zml.Platform, sharding: zml.Sharding, args: Args) !void {
    ...
    var token_index_buffer = try zml.Buffer.scalar(io, platform, args.token_index, .u32);
