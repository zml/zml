//! Harness registration for `_kernel_unified_attention_sparse_mla_2d_ptr`.
//!
//! This is wired as a local Zig DSL kernel because no production sparse-MLA
//! kernel exists in the current `@zml` checkout yet.
...
const MAX_NUM_QUERY_HEADS: i64 = 32;
const MAX_BLOCK_SIZE: i64 = 16;
const MAX_NUM_BLOCKS: i64 = 64;
const MAX_TOPK: i64 = 32;
const MAX_ROPE_RANK: i64 = 64;
const MAX_KV_LORA_RANK: i64 = 512;
const MAX_Q_WIDTH: i64 = MAX_KV_LORA_RANK + MAX_ROPE_RANK;
const MAX_Q_BUF: i64 = MAX_NUM_TOKENS * MAX_NUM_QUERY_HEADS * MAX_Q_WIDTH;
const MAX_K_BUF: i64 = MAX_NUM_BLOCKS * MAX_BLOCK_SIZE * MAX_Q_WIDTH;
const MAX_V_BUF: i64 = MAX_NUM_BLOCKS * MAX_BLOCK_SIZE * MAX_KV_LORA_RANK;
const MAX_O_BUF: i64 = MAX_NUM_TOKENS * MAX_NUM_QUERY_HEADS * MAX_KV_LORA_RANK;

threadlocal var active_ttir: [:0]const u8 = "";

pub fn setActiveTtir(ir: [:0]const u8) void {
    active_ttir = ir;
}
