...
const Layer = struct {
    pub fn forward(_: Layer, a: zml.Tensor, b: zml.Tensor) zml.Tensor {
        ...
        // const custom_call_result = zml.custom_call(AddOp, .{res2}, &[_]zml.Shape{res2.shape()}, a.getContext(), &.{0});

        // return custom_call_result[0];
...
pub fn asyncMain() !void {
    ...
    add_op_ctx.* = .{ .platform = platform, .buffer = custom_call_buffer };
