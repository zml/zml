...
// =============================================================================
// draft/encoder.zig — H3 text encoder
//
// 50 layers, GQA. Embed table stays replicated.
// =============================================================================
...
const SelfAttn = struct {
    ...
    pub fn forward(self: SelfAttn, x: zml.Tensor, cos: zml.Tensor, sin: zml.Tensor) zml.Tensor {
        ...
        const attn = qwenSdpa(q_s, k_s, v_s).rename(.{ .q = .s }).merge(.{ .d = .{ .h, .hd } });
...
pub const TransformerLayer = struct {
    ...
    pub fn forward(input: Input) Output {
        ...
        const hidden = x1.add(mlp).withPartitioning(.{ .d = .replicated });
