...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export audio patchify activation fixture from replay .pt to safetensors")
    ...
    parser.add_argument(
        "--activation-key",
        default="velocity_model.audio_patchify_proj",
