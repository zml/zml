#loc = loc("/workspace/pa_decode_rework.py":159:0)
#loc1 = loc(unknown)
#loc54 = loc("/workspace/pa_decode_rework.py":273:42)
#loc71 = loc("/workspace/pa_decode_rework.py":288:43)
...
module {
  tt.func public @_paged_attn_decode_v1_w_dot_kernel_tt_load_only(%ptr1: !tt.ptr<bf16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %ptr2: !tt.ptr<bf16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %ptr3: !tt.ptr<bf16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %ptr4: !tt.ptr<i32> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %ptr5: !tt.ptr<i64> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %ptr6: !tt.ptr<f32, 1> {tt.divisibility = 16 : i32}, %ptr7: !tt.ptr<f32, 1> {tt.divisibility = 16 : i32}, %ptr8: !tt.ptr<f32, 1> {tt.divisibility = 16 : i32}, %ptr9: !tt.ptr<i32, 1> {tt.divisibility = 16 : i32}, %ptr10: !tt.ptr<i32, 1> {tt.divisibility = 16 : i32}, %ptr11: !tt.ptr<i32, 1> {tt.divisibility = 16 : i32}, %ptr12: !tt.ptr<i32, 1> {tt.divisibility = 16 : i32}, %ptr13: !tt.ptr<i32, 1> {tt.divisibility = 16 : i32}, %ptr14: !tt.ptr<i32, 1> {tt.divisibility = 16 : i32}, %ptr15: !tt.ptr<i32, 1> {tt.divisibility = 16 : i32}, %ptr16: !tt.ptr<i32, 1> {tt.divisibility = 16 : i32}, %ptr0: !tt.ptr<bf16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}) {
    ...
    // tt.print "stride 0 " {hex = false, isSigned = array<i32: 0, 0, 0>} : %3, %4, %5 : i32, i32, i32
    // tt.print "stride 2" {hex = false, isSigned = array<i32: 0>} : %4 : i32
    // tt.print "stride 2" {hex = false, isSigned = array<i32: 0>} : %5 : i32
  ...
  tt.func private @_paged_attn_decode_v1_w_dot_kernel(%arg0: !tt.ptr<bf16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %arg1: !tt.ptr<bf16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %arg2: !tt.ptr<bf16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %arg3: !tt.ptr<bf16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %arg4: !tt.ptr<i32> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %arg5: !tt.ptr<i64> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32}, %arg6: f32, %arg7: f32, %arg8: f32, %arg9: i32 {tt.divisibility = 16 : i32}, %arg10: i32 {tt.divisibility = 16 : i32}, %arg11: i32 {tt.divisibility = 16 : i32}, %arg12: i32 {tt.divisibility = 16 : i32}, %arg13: i32 {tt.divisibility = 16 : i32}, %arg14: i32 {tt.divisibility = 16 : i32}, %arg15: i32 {tt.divisibility = 16 : i32}, %arg16: i32 {tt.divisibility = 16 : i32}) attributes {noinline = false} {
...
#loc2 = loc("/workspace/pa_decode_rework.py":194:28)
#loc3 = loc("/workspace/pa_decode_rework.py":195:32)
#loc4 = loc("/workspace/pa_decode_rework.py":199:37)
#loc5 = loc("/workspace/pa_decode_rework.py":199:22)
#loc6 = loc("/usr/local/lib/python3.12/dist-packages/triton/language/standard.py":40:22)
#loc7 = loc("/workspace/pa_decode_rework.py":201:35)
#loc8 = loc("/usr/local/lib/python3.12/dist-packages/triton/language/standard.py":40:28)
#loc9 = loc("/workspace/pa_decode_rework.py":203:28)
#loc10 = loc("/workspace/pa_decode_rework.py":204:32)
#loc11 = loc("/workspace/pa_decode_rework.py":218:18)
#loc12 = loc("/workspace/pa_decode_rework.py":219:25)
#loc13 = loc("/workspace/pa_decode_rework.py":219:51)
#loc14 = loc("/workspace/pa_decode_rework.py":219:40)
#loc15 = loc("/workspace/pa_decode_rework.py":219:63)
#loc16 = loc("/workspace/pa_decode_rework.py":219:10)
#loc17 = loc("/workspace/pa_decode_rework.py":220:23)
#loc18 = loc("/workspace/pa_decode_rework.py":220:10)
#loc19 = loc("/workspace/pa_decode_rework.py":224:36)
#loc20 = loc("/workspace/pa_decode_rework.py":224:77)
#loc21 = loc("/workspace/pa_decode_rework.py":224:53)
#loc22 = loc("/workspace/pa_decode_rework.py":226:24)
#loc23 = loc("/workspace/pa_decode_rework.py":226:16)
#loc24 = loc("/workspace/pa_decode_rework.py":227:13)
#loc25 = loc("/workspace/pa_decode_rework.py":227:23)
#loc26 = loc("/workspace/pa_decode_rework.py":234:22)
#loc27 = loc("/workspace/pa_decode_rework.py":235:30)
#loc28 = loc("/workspace/pa_decode_rework.py":235:10)
#loc29 = loc("/workspace/pa_decode_rework.py":236:10)
#loc30 = loc("/workspace/pa_decode_rework.py":238:51)
#loc31 = loc("/workspace/pa_decode_rework.py":238:41)
#loc32 = loc("/workspace/pa_decode_rework.py":243:39)
#loc33 = loc("/workspace/pa_decode_rework.py":245:37)
#loc34 = loc("/workspace/pa_decode_rework.py":246:35)
#loc35 = loc("/workspace/pa_decode_rework.py":251:36)
#loc36 = loc("/workspace/pa_decode_rework.py":258:76)
#loc37 = loc("/workspace/pa_decode_rework.py":258:52)
#loc38 = loc("/workspace/pa_decode_rework.py":281:36)
#loc39 = loc("/workspace/pa_decode_rework.py":240:19)
#loc40 = loc("/workspace/pa_decode_rework.py":241:50)
#loc41 = loc("/workspace/pa_decode_rework.py":241:30)
#loc42 = loc("/workspace/pa_decode_rework.py":242:36)
#loc43 = loc("/workspace/pa_decode_rework.py":242:49)
#loc44 = loc("/workspace/pa_decode_rework.py":243:27)
#loc45 = loc("/workspace/pa_decode_rework.py":245:26)
#loc46 = loc("/workspace/pa_decode_rework.py":246:15)
#loc47 = loc("/workspace/pa_decode_rework.py":247:15)
#loc48 = loc("/workspace/pa_decode_rework.py":251:22)
#loc49 = loc("/workspace/pa_decode_rework.py":256:23)
#loc50 = loc("/workspace/pa_decode_rework.py":258:65)
#loc51 = loc("/workspace/pa_decode_rework.py":260:12)
#loc52 = loc("/workspace/pa_decode_rework.py":271:12)
...
#loc56 = loc("/workspace/pa_decode_rework.py":273:55)
#loc57 = loc("/workspace/pa_decode_rework.py":276:45)
#loc58 = loc("/workspace/pa_decode_rework.py":276:31)
#loc59 = loc("/workspace/pa_decode_rework.py":276:57)
#loc60 = loc("/workspace/pa_decode_rework.py":276:25)
#loc61 = loc("/workspace/pa_decode_rework.py":277:42)
#loc62 = loc("/workspace/pa_decode_rework.py":277:59)
#loc63 = loc("/workspace/pa_decode_rework.py":277:29)
#loc64 = loc("/workspace/pa_decode_rework.py":278:21)
#loc65 = loc("/workspace/pa_decode_rework.py":278:15)
#loc66 = loc("/workspace/pa_decode_rework.py":281:22)
#loc67 = loc("/workspace/pa_decode_rework.py":285:17)
#loc68 = loc("/workspace/pa_decode_rework.py":286:25)
#loc69 = loc("/workspace/pa_decode_rework.py":288:28)
...
#loc74 = loc("/workspace/pa_decode_rework.py":288:36)
#loc75 = loc("/workspace/pa_decode_rework.py":289:8)
#loc76 = loc("/workspace/pa_decode_rework.py":291:24)
#loc77 = loc("/workspace/pa_decode_rework.py":291:16)
#loc78 = loc("/workspace/pa_decode_rework.py":294:18)
#loc79 = loc("/workspace/pa_decode_rework.py":295:63)
#loc80 = loc("/workspace/pa_decode_rework.py":295:10)
#loc81 = loc("/workspace/pa_decode_rework.py":296:10)
#loc82 = loc("/workspace/pa_decode_rework.py":300:23)
#loc83 = loc("/workspace/pa_decode_rework.py":300:40)
#loc84 = loc("/workspace/pa_decode_rework.py":300:33)
#loc85 = loc("/workspace/pa_decode_rework.py":300:4)
