...
const stdx = zml.stdx;
const cublas_gg = zml.grouped_gemm;
    ...
    pub fn forward(self: MoE, input: Tensor, tokens_mask: ?Tensor, host_buffer_input: Tensor, device_buffer_input: Tensor) struct { Tensor, Tensor, Tensor } {
        ...
        if (tokens_mask) |mask| {
            ...
            for (0..self.moe_opts.experts_per_token) |i| {
                ...
                host_buffer, device_buffer, var out_gate_up = Tensor.gemmGroupedBatched(
                    weights_gate_up,
                    input_sorted,
                ...
                host_buffer, device_buffer, var moe_out = Tensor.gemmGroupedBatched(
                    weights_down,
                    out,
                    counts_tokens_per_exp,
                    host_buffer,
