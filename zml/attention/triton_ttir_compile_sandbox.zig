...
fn bootstrapPythonPath() !void {
    const code: [:0]const u8 =
        ...
        \\    roots.append(os.path.realpath(os.path.join(exe_dir, "..", "zml_ttir_compile_sandbox.runfiles")))
        ...
        \\            os.path.join(root, "_main", "zml", "attention", "triton_prefill_py"),
        \\            os.path.join(root, "zml", "attention", "triton_prefill_py"),
