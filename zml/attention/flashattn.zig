...
pub const paged_fa2 = struct {
    ...
    pub const DecodeMetadata = struct {
        ...
        pub fn initBuffers(self: *const DecodeMetadata, io: std.Io, platform: zml.Platform, out_accum_sharding: *const zml.sharding.Sharding) !zml.Bufferized(DecodeMetadata) {
            return .{
    ...
    pub const MixedMetadata = struct {
        ...
        pub fn initBuffers(self: *const MixedMetadata, io: std.Io, platform: zml.Platform, out_accum_sharding: *const zml.sharding.Sharding) !zml.Bufferized(MixedMetadata) {
            return .{
                .out_accum = try zml.Buffer.uninitialized(io, &platform, self.out_accum.shape(), out_accum_sharding, .{}),
