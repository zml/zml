...
pub const Float8E4M3B11FNUZ = floats.Float8E4M3B11FNUZ;
pub const Float8E4M3FN = floats.Float8E4M3FN;
pub const Float8E4M3FNUZ = floats.Float8E4M3FNUZ;
pub const Float8E5M2 = floats.Float8E5M2;
pub const Float8E5M2FNUZ = floats.Float8E5M2FNUZ;
pub const BFloat16 = floats.BFloat16;

pub const C64 = std.math.Complex(f32);
pub const C128 = std.math.Complex(f64);
...
pub const DataType = enum(u8) {
    ...
    pub fn fromZigType(comptime T: type) DataType {
        return switch (T) {
            Float8E4M3B11FNUZ => .f8e4m3b11fnuz,
    ...
    pub fn minValue(dtype: DataType) Value {
        return switch (dtype) {
            ...
            inline .i4, .i8, .i16, .i32, .i64, .u4, .u8, .u16, .u32, .u64 => |tag| @unionInit(Value, @tagName(tag), std.math.minInt(@FieldType(Value, @tagName(tag)))),
    ...
    pub fn maxValue(dtype: DataType) Value {
        return switch (dtype) {
            ...
            inline .f16, .f32, .f64 => |tag| @unionInit(Value, @tagName(tag), std.math.inf(@FieldType(Value, @tagName(tag)))),
            inline .i4, .i8, .i16, .i32, .i64, .u4, .u8, .u16, .u32, .u64 => |tag| @unionInit(Value, @tagName(tag), std.math.maxInt(@FieldType(Value, @tagName(tag)))),
