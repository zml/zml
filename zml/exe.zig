...
pub const BaseExe = struct {
    ...
    pub fn deinit(self: BaseExe) void {
        ...
        // Alternative to arena: free our only memory slice.
        // stdx.mem.groupedFree(
        //     struct { []*pjrt.Buffer, []Shape },
        //     arena.allocator(),
        //     .{ self.input_per_device[0][0..self.num_inputs], self.output_shapes },
        // );
